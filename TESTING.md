...
- https://validator.w3.org/nu/?doc=https://fattig-riddare-90.github.io/machine-ready/index.html
...
- https://jigsaw.w3.org/css-validator/validator?uri=https://fattig-riddare-90.github.io/machine-ready
...
| Directory | File | URL | Screenshot | Notes |
| --- | --- | --- | --- | --- |
| assets | [manager.js](https://github.com/fattig-riddare-90/machine-ready/blob/main/assets/js/manager.js) | N/A | ![screenshot](documentation/validation/js-assets-manager.png) | Notes (if applicable) |
| assets | [operator.js](https://github.com/fattig-riddare-90/machine-ready/blob/main/assets/js/operator.js) | N/A | ![screenshot](documentation/validation/js-assets-operator.png) | Notes (if applicable) |
| assets | [start.js](https://github.com/fattig-riddare-90/machine-ready/blob/main/assets/js/start.js) | N/A | ![screenshot](documentation/validation/js-assets-start.png) | Notes (if applicable) |
| assets | [utility.js](https://github.com/fattig-riddare-90/machine-ready/blob/main/assets/js/utility.js) | N/A | ![screenshot](documentation/validation/js-assets-utility.png) | Notes (if applicable) |
...
Alternatively, an improved way to manage bugs is to use the built-in **[Issues](https://www.github.com/fattig-riddare-90/machine-ready/issues)** tracker on your GitHub repository. This can be found at the top of your repository, the tab called "Issues".
